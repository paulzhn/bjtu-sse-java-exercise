...
public class ReadFamilies {
    public static void main(String[] args) {
        ...
        try {
            FileInputStream fStream = new FileInputStream("families.ser");
            ...
            family1 = (Family)inStream.readObject();
            family2 = (Family)inStream.readObject();
            family3 = (Family)inStream.readObject();
            inStream.close();
